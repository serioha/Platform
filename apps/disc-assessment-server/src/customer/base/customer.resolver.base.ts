...
export class CustomerResolverBase {
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [AssessmentResult], { name: "assessmentResults" })
  @nestAccessControl.UseRoles({
  ...
  async findAssessmentResults(
    ...
    const results = await this.service.findAssessmentResults(parent.id, args);
  ...
  async SendReportEmail(
    ...
    return this.service.SendReportEmail(args);
  }
}
